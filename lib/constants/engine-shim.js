...
// the Monte Carlo engine and the report renderer. Exported as plain ESM so
// .js engine code can import without TypeScript tooling. Spliced into the
// generated lib/engine/index.js by scripts/gen-engine-from-planner.mjs.
// (The former TS canon lib/constants/engine-constants-2026.ts was deleted
// 2026-07-03 — it was a dead, drifted duplicate; this file is now the sole
// fiscal-constant SSOT. Guarded by tests/constants-c-shim-drift.test.ts.)
//
// IMPORTANT
...
//   * To update for a new tax year, EDIT THIS FILE, run the regression
//     test suite (fiscal-constants-sync, constants-drift, engine-parity),
//     then ship.
...
//   Quebec (QC tax), provincial tax acts (other provinces). OAS/GIS
//   standardized to Q1 2026 (audit 2.13) as the canonical quarter.
// ══════════════════════════════════════════════════════════════════════
