...
export function buildAIPromptInter(
  ...
  const sys = "You narrate buildfi.ca Intermediaire reports ($59 tier).\n"
    ...
    + "\n=== DENSITY (INTERMEDIATE TIER) ===\n"
    + "2-3 sentences per slot. Each sentence carries a data point or an implication. Comparative framing preferred (X vs Y, now vs retirement). No bullet points in narration.\n"
    ...
    + "obs_1 through obs_5 must each cover a DIFFERENT analytical dimension:\n"
    + "- Financial (rates, amounts, costs)\n"
    + "- Temporal (timeline, sequence, compounding runway)\n"
    + "- Behavioral (spending, flexibility, habits)\n"
    + "- Structural (account mix, tax positioning, couple dynamics)\n"
