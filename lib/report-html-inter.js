...
function renderReport(D, mc, stratData, params, ai, aiLoading, lang, costDelay, minReturn, obsLabels) {
  ...
  function aiSlot(text, fallback) {
    if (aiLoading) return '<div style="font-size:14px;color:#888;padding:12px 16px;background:#FDFBF7;border-left:3px solid #C4944A;border-radius:4px;font-style:italic;margin:12px 0">\u2026</div>';
    if (!text) return fallback ? '<div style="font-size:14px;color:#444;line-height:1.75;margin:12px 0;padding:12px 16px;background:#FDFBF7;border-left:3px solid #C4944A;border-radius:4px">' + fallback + '</div>' : '';
    return '<div style="font-size:14px;color:#444;line-height:1.75;margin:14px 0;padding:12px 16px;background:#FDFBF7;border-left:3px solid #C4944A;border-radius:4px">' + text + '</div>';
  }
  ...
  (function() {
    ...
    var legX = P + 4, legItems = [{ c: "rgba(196,148,74,0.55)", l: t("REER", "RRSP") }, { c: "rgba(42,140,70,0.45)", l: t("CELI", "TFSA") }, { c: "rgba(184,152,48,0.45)", l: t("NR", "NR") }, { c: "rgba(70,128,192,0.4)", l: t("CRI", "LIRA") }, { c: "rgba(70,128,192,0.4)", l: "DC/Corp" }];
  ...
  (function() {
    ...
    var items = [{ v: qppMo, c: "#2A8C46", l: isQC ? "RRQ" : t("RPC", "CPP") }, { v: oasMo, c: "#4680C0", l: t("PSV", "OAS") }, { v: penM, c: "#4680C0", l: t("Pension PD", "DB Pension") }, { v: savM, c: "#C4944A", l: t("\u00c9pargne", "Savings") }].filter(function(i) { return i.v > 0; });
  ...
  if (priorities.length > 0) {
    ...
    h += priorities.map(function(pr, i) {
      ...
      return '<div style="margin-bottom:16px">'
        ...
        + '<span style="display:inline-flex;align-items:center;justify-content:center;width:28px;height:28px;border-radius:50%;background:#C4944A;color:#fff;font-size:12px;font-weight:800;flex-shrink:0">' + (i + 1) + '</span>'
...
+ '  --pr:#C4944A;--bga:rgba(196,148,74,.04);'
