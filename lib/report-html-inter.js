...
function renderReport(D, mc, stratData, params, ai, aiLoading, lang, costDelay, minReturn, obsLabels) {
  ...
  h += '<div class="co cogn">'
    + '<div style="font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:.8px;color:var(--gn);margin-bottom:8px">' + t("Votre action n\u00ba\u00a01 \u2014 cette semaine", "Your action #1 \u2014 this week") + '</div>'
