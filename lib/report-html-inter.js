...
function renderReport(D, mc, stratData, params, ai, aiLoading, lang, costDelay, minReturn, obsLabels) {
  ...
  var probTranslation = D.successPct === 0
    ...
    : D.successPct <= 10 ? t("Autrement dit\u00a0: dans environ 9 sc\u00e9narios sur 10, l\u2019\u00e9pargne pourrait s\u2019\u00e9puiser avant la fin de la retraite.", "In other words: in roughly 9 out of 10 scenarios, savings could be depleted before the end of retirement.")
    ...
    : D.successPct <= 40 ? t("Autrement dit\u00a0: dans plus de 1 sc\u00e9nario sur 2, des ajustements pourraient \u00eatre n\u00e9cessaires.", "In other words: in more than 1 out of 2 scenarios, adjustments may be needed.")
    ...
    : D.successPct <= 89 ? t("Autrement dit\u00a0: dans environ 1 sc\u00e9nario sur 10, le plan pourrait n\u00e9cessiter des ajustements.", "In other words: in roughly 1 out of 10 scenarios, the plan may require some adjustments.")
