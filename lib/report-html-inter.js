...
function renderReport(D, mc, stratData, params, ai, aiLoading, lang, costDelay, minReturn, obsLabels) {
  ...
  h += aiSlot(ai.income_mix, t(
    "Vos revenus gouvernementaux (" + (isQC ? "RRQ" : "RPC") + " + " + t("PSV", "OAS") + ") pourraient couvrir " + D.coveragePct + "\u00a0% de votre budget de retraite cible de " + f$(D.retSpM) + "/mois. " + (D.gapMonthly > 0 ? "Un d\u00e9ficit mensuel de " + f$(D.gapMonthly) + " devrait \u00eatre financ\u00e9 par votre \u00e9pargne personnelle." : "Vos revenus gouvernementaux couvrent l\u2019ensemble de votre budget cible."),
