...
<div class="container">
  ...
  <div class="no-print" style="text-align:center;margin:16px 0;padding:12px;border:1px solid var(--border);border-radius:8px;font-size:12px;color:var(--gray);line-height:1.8">
    ${fr ? "Connaissez-vous quelqu\u2019un qui gagnerait \u00e0 faire le point sur sa retraite\u00a0? Partagez BuildFi." : "Know someone who could benefit from a clear retirement snapshot? Share BuildFi."}
