...
<title>${fr ? "Bilan Décaissement — buildfi.ca" : "Retirement Drawdown Assessment — buildfi.ca"}</title>
<style>${css}</style>
</head>
<body>
<div class="container">
  ...
  <div class="report-header">
    ...
    <div class="tier-badge">${fr ? "Bilan Décaissement" : "Retirement Drawdown Assessment"}</div>
