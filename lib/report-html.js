...
function renderReport_v6(D, mc, quiz, ai, aiLoading, lang, costDelay, minReturn) {
  ...
  h += '\u2022 <a href="https://www.buildfi.ca/outils/dettes" style="color:var(--gd);text-decoration:none;font-weight:600">' + t("Outil d\u2019analyse des dettes","Debt analysis tool") + '</a> \u2014 ' + t("interactif, analyse des strat\u00e9gies de remboursement, z\u00e9ro frais","interactive, repayment strategy analysis, zero cost") + '<br>';
  ...
  // Guide 201+301 is Intermediaire-only — not included in Essentiel
  h += '</div></div>';
