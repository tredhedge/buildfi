...
function renderReport_v5(D, mc, quiz, ai, aiLoading, lang, costDelay, minReturn) {
  ...
  function aiSlot(text) {
    if (aiLoading) return '<div style="font-size:14px;color:#888;line-height:1.75;margin:12px 0;padding:12px 16px;background:#FDFBF7;border-left:3px solid #C4944A;border-radius:4px;font-style:italic">\u2026</div>';
    if (!text) return '';
    return '<div style="font-size:14px;color:#444;line-height:1.75;margin:12px 0;padding:12px 16px;background:#FDFBF7;border-left:3px solid #C4944A;border-radius:4px">' + text + '</div>';
  }
  ...
  if (rp.debtBal > 0 || rp.mortBal > 0) {
    ...
    h += '</div>';
    h += '<div style="background:#FFF9F0;border:2px solid #C4944A;border-radius:8px;padding:20px 24px;margin:24px 0">';
    ...
    priorities.forEach(function(p, i) {
      ...
      h += '<span style="display:inline-flex;align-items:center;justify-content:center;width:28px;height:28px;border-radius:50%;background:#C4944A;color:#fff;font-size:12px;font-weight:800;flex-shrink:0">' + (i+1) + '</span>';
...
function renderReport_v6(D, mc, quiz, ai, aiLoading, lang, costDelay, minReturn) {
  ...
  h += '<div style="background:linear-gradient(135deg,#1A1208 0%,#2D2010 100%);color:#fff;border-radius:14px;padding:24px 28px;margin:8px 0 12px;">'
    + '<div style="font-size:11px;text-transform:uppercase;letter-spacing:2px;color:#C4944A;margin-bottom:12px;font-weight:600;">' + t("Votre situation en 30 secondes", "Your situation in 30 seconds") + '</div>'
  ...
  h += '<div style="background:linear-gradient(135deg,#1A1208 0%,#2D2010 100%);color:#fff;border-radius:14px;padding:28px;margin:24px 0;">'
    + '<div style="font-size:11px;text-transform:uppercase;letter-spacing:2px;color:#C4944A;margin-bottom:12px;font-weight:600;">' + t("En r\u00e9sum\u00e9", "In summary") + '</div>'
    + '<div style="font-size:15px;line-height:1.8;color:#E8E0D4;">'
    + (D.successPct >= 85
  ...
  h += '<a href="https://www.buildfi.ca/outils/dettes" target="_blank" rel="noopener" style="display:flex;align-items:center;gap:14px;text-decoration:none;background:#fff;border:1px solid rgba(196,148,74,.22);border-radius:9px;padding:13px 16px;margin-bottom:10px;transition:border-color .15s,box-shadow .15s" onmouseover="this.style.borderColor=\'rgba(196,148,74,.55)\';this.style.boxShadow=\'0 2px 8px rgba(196,148,74,.12)\'" onmouseout="this.style.borderColor=\'rgba(196,148,74,.22)\';this.style.boxShadow=\'none\'">';
  h += '<span style="font-size:24px;flex-shrink:0">\ud83e\uddee</span>';
...
function upgradeCtaHTML(fr, price) {
  ...
  return '<div class="no-print" style="max-width:640px;margin:40px auto 30px;padding:24px 28px;'
    + 'background:rgba(196,148,74,.06);border:1.5px solid rgba(196,148,74,.2);border-radius:12px;text-align:center">'
...
'.ex strong{color:#555}' +
'.ai{font-size:14px;color:#444;line-height:1.85;margin:14px 0;padding:14px 18px;background:#FDFBF7;border-radius:4px;border-left:3px solid #C4944A}' +
