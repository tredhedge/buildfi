...
function renderReport_v6(D, mc, quiz, ai, aiLoading, lang, costDelay, minReturn) {
  ...
  if (gi.g === 'F' || gi.g === 'D') {
    ...
    else if (ytr <= 5) actionHintText = t("Plan robuste. Avec la retraite dans " + ytr + " ans, les dimensions cl\u00e9s seraient le d\u00e9caissement et le timing " + qppLabel + "/PSV.", "Solid plan. With retirement " + ytr + " years away, key dimensions would be withdrawal strategy and " + qppLabel + "/OAS timing.");
