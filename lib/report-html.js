...
function renderReport_v5(D, mc, quiz, ai, aiLoading, lang, costDelay, minReturn) {
  ...
  h += '<div style="margin-bottom:28px;padding:16px 18px;border:1px solid var(--bd);border-radius:10px;font-size:13px;color:var(--ts);line-height:1.8;text-align:center">';
  h += t("Ce bilan couvre les fondamentaux. Pour une analyse plus fine — couple, immobilier, décaissement — d\u2019autres options sont disponibles sur ", "This assessment covers the fundamentals. For deeper analysis — couples, real estate, drawdown — other options are available at ");
  h += '<a href="https://www.buildfi.ca/#products" style="color:var(--g);text-decoration:none;font-weight:600">buildfi.ca</a>';
  h += '</div>';
...
function renderReport_v6(D, mc, quiz, ai, aiLoading, lang, costDelay, minReturn) {
  ...
  // ═══ CONTEXTUAL NEXT STEP (soft, confidence-first) ═══
  if (ai.upgrade_hook) h += '<div class="ai" style="margin:20px 0">' + ai.upgrade_hook + '</div>';
  h += '<div class="np" style="margin-bottom:28px;padding:16px 18px;border:1px solid var(--bdl);border-radius:var(--rad);font-size:13px;color:var(--ts);line-height:1.8;text-align:center">';
  h += t("Ce bilan couvre les fondamentaux. Pour une analyse plus fine — couple, immobilier, décaissement — d\u2019autres options sont disponibles sur ", "This assessment covers the fundamentals. For deeper analysis — couples, real estate, drawdown — other options are available at ");
  h += '<a href="https://www.buildfi.ca/#products" style="color:var(--gd);text-decoration:none;font-weight:600">buildfi.ca</a>';
  h += '</div>';
