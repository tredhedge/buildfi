...
function extractReportData(mc, p) {
  ...
  // Grade scale — canonical 8-level (matches gradeInfo and api-helpers.ts)
  var grade;
...
function renderReport_v6(D, mc, quiz, ai, aiLoading, lang, costDelay, minReturn) {
  ...
  // ═══ BONUS RESOURCES ═══
  h += '<div class="c np" style="margin-bottom:20px;padding:16px 18px">';
  h += '<div style="font-size:13px;font-weight:700;color:var(--ts);margin-bottom:8px">' + t("Ressources incluses","Included resources") + '</div>';
  h += '<div style="font-size:13px;color:var(--ts);line-height:1.9">';
  h += '\u2022 <a href="https://www.buildfi.ca/outils/dettes" style="color:var(--gd);text-decoration:none;font-weight:600">' + t("Outil d\u2019analyse des dettes","Debt analysis tool") + '</a> \u2014 ' + t("interactif, strat\u00e9gie optimale, z\u00e9ro frais","interactive, optimal strategy, zero cost") + '<br>';
  h += '\u2022 <a href="https://www.buildfi.ca/' + t("guide-101-les-bases-de-vos-finances.pdf","guide-101-your-financial-basics.pdf") + '" style="color:var(--gd);text-decoration:none;font-weight:600">' + t("Guide 101 : Les bases de vos finances","Guide 101: Your Financial Basics") + '</a> \u2014 ' + t("PDF, 20+ pages, bilingue","PDF, 20+ pages, bilingual") + '<br>';
  h += '\u2022 <a href="https://www.buildfi.ca/' + t("guide-201-optimiser-votre-retraite.pdf","guide-201-optimize-your-retirement.pdf") + '" style="color:var(--gd);text-decoration:none;font-weight:600">' + t("Guide 201+301 : Optimiser et ma\u00eetriser votre retraite","Guide 201+301: Optimize & Master Your Retirement") + '</a> \u2014 ' + t("strat\u00e9gies interm\u00e9diaires et avanc\u00e9es","intermediate & advanced strategies");
  h += '</div></div>';
  ...
  // ═══ REFERRAL ═══
  h += '<div style="text-align:center;margin:16px 0;padding:12px;border:1px solid var(--bdl);border-radius:var(--rad);font-size:12px;color:var(--tm);line-height:1.8">';
  ...
  h += ' <a href="https://www.buildfi.ca" style="color:var(--gd);text-decoration:none;font-weight:600">buildfi.ca</a>';
  h += '</div>';
  ...
  h += '<a href="/quiz/intermediaire" style="display:block;text-align:center;padding:18px;background:linear-gradient(135deg,var(--gd),var(--gl));color:#fff;border-radius:var(--rad);text-decoration:none;font-weight:700;font-size:15px">' + t("Interm\u00e9diaire \u2014 59 $","Intermediate \u2014 $59") + '<div style="font-size:11px;font-weight:400;opacity:.8;margin-top:4px">' + t("16 sections \u00b7 strat\u00e9gie de d\u00e9caissement \u00b7 " + qppLabel + " optimal","16 sections \u00b7 decumulation strategy \u00b7 optimal " + qppLabel) + '</div></a>';
  h += '<a href="/quiz/expert" style="display:block;text-align:center;padding:18px;border:2px solid var(--bd);color:var(--tx);border-radius:var(--rad);text-decoration:none;font-weight:700;font-size:15px">' + t("Expert \u2014 129 $","Expert \u2014 $129") + '<div style="font-size:11px;font-weight:400;color:var(--tm);margin-top:4px">' + t("28 sections \u00b7 immobilier \u00b7 couple \u00b7 incorpor\u00e9","28 sections \u00b7 real estate \u00b7 couple \u00b7 incorporated") + '</div></a>';
  h += '</div>';
...
export function renderReportHTML(D, mc, quiz, lang, ai, costDelay, minReturn, feedbackToken) {
  ...
  reportBody += upgradeCtaHTML(fr, '29');
