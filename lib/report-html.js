...
function renderReport_v6(D, mc, quiz, ai, aiLoading, lang, costDelay, minReturn) {
  ...
  else if (D.successPct <= 10) probTranslation = t("Autrement dit\u00a0: dans environ 9 sc\u00e9narios sur 10, l\u2019\u00e9pargne pourrait s\u2019\u00e9puiser avant la fin de la retraite.", "In other words: in roughly 9 out of 10 scenarios, savings could be depleted before the end of retirement.");
  ...
  else if (D.successPct <= 40) probTranslation = t("Autrement dit\u00a0: dans plus de 1 sc\u00e9nario sur 2, des ajustements pourraient \u00eatre n\u00e9cessaires.", "In other words: in more than 1 out of 2 scenarios, adjustments may be needed.");
  ...
  else if (D.successPct <= 89) probTranslation = t("Autrement dit\u00a0: dans environ 1 sc\u00e9nario sur 10, le plan pourrait n\u00e9cessiter des ajustements.", "In other words: in roughly 1 out of 10 scenarios, the plan may require some adjustments.");
