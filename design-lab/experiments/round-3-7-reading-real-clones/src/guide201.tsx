    ...
    <div className="bfe-shell bfe-shell--guide">
      ...
      <main className="bfe-main">
        ...
        <Note tone="rule" kicker="BONUS">
          ...
          <a href={labHref(t.simHref)} className="bfe-btn-glass" style={{ minHeight: 38, padding: "0 16px", fontSize: 13 }}>{t.simBtn}</a>
        </Note>
        ...
        <section className="bfe-section" style={{ background: CL.ink, color: "#fff", borderColor: CL.ink }}>
          ...
          <div style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
            <a href={labHref(t.ctaHref)} className="bfe-btn-gold">{t.ctaBtn}</a>
            <a href={labHref(t.ctaBundleHref)} style={{ display: "inline-flex", alignItems: "center", justifyContent: "center", minHeight: 46, padding: "0 18px", borderRadius: 999, color: "#fff", border: "1px solid rgba(255,255,255,.35)", textDecoration: "none", fontWeight: 700 }}>{t.ctaBundle}</a>
          </div>
        </section>
