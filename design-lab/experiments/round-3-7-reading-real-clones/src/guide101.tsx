...
import Link, { labHref, useSearchParams } from "./next-shim";
    ...
    <div className="bfe-shell bfe-shell--guide">
      ...
      <aside className="bfe-rail">
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 10, marginTop: 20 }}>
          <a className="bfe-btn-glass" href={labHref(t.pdfHref)}>📄 {t.pdfLabel}</a>
      ...
      <main className="bfe-main">
        ...
        <Section fr={fr} num={9} id="ch9" title={t.actionsTitle} sub={t.quote2}>
          ...
          <div style={{ background: CL.ink, color: "#fff", borderRadius: 14, padding: "22px 24px" }}>
            ...
            <a href={labHref(t.ctaHref)} style={{ display: "inline-block", background: CL.gold, color: CL.ink, padding: "12px 22px", borderRadius: 10, fontSize: 14, fontWeight: 800, textDecoration: "none" }}>{t.ctaBtn}</a>
          </div>
        </Section>
