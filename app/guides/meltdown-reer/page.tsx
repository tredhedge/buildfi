...
/*
  ...
  Codex was right that this guide doesn't have a section-id substrate
  by default — h2s were inline-styled with no anchors. The RAIL_TOC
  list below is the source of truth for the sticky rail; each entry's
  id must match the corresponding <h2 id="...">.
*/
const RAIL_TOC: { id: string; label: string }[] = [
  { id: "sec-probleme", label: "Le problème : retraits FERR" },
  { id: "sec-solution", label: "La solution : retirer plus tôt" },
  { id: "sec-exemple", label: "Exemple chiffré" },
  { id: "sec-zone-doree", label: "Zone dorée : 60-65 ans" },
  { id: "sec-quand-pas", label: "Quand ça ne vaut pas la peine" },
  { id: "sec-pieges", label: "3 pièges courants" },
  { id: "sec-vs-fractionnement", label: "Meltdown vs fractionnement" },
];
...
export default function MeltdownArticle() {
  ...
  return (
    <>
      <EditorialHeader lang="fr" eyebrow="Guide avancé · 10 min de lecture" />
      <div className="bfe-shell bfe-shell--guide" style={{ maxWidth: 1340, padding: "12px 24px 80px" }}>
        ...
        <main style={{ minWidth: 0, maxWidth: 880 }}>
          <article style={{ lineHeight: 1.75 }}>
            ...
            <h2 id="sec-probleme" style={articleHeading}>
            ...
            <h2 id="sec-solution" style={articleHeading}>
            ...
            <h2 id="sec-exemple" style={articleHeading}>
              Exemple chiffré
            </h2>
            ...
            <h2 id="sec-zone-doree" style={articleHeading}>
            ...
            <h2 id="sec-quand-pas" style={articleHeading}>
            ...
            <h2 id="sec-pieges" style={articleHeading}>
              Les 3 pièges courants
            </h2>

            <h3 style={subHeading}>1. Meltdown sans plafond</h3>
            <p>
            ...
            <h3 style={subHeading}>2. Déposer dans le mauvais compte</h3>
            <p>
            ...
            <h3 style={subHeading}>3. Oublier la retenue à la source</h3>
            <p>
            ...
            <h2 id="sec-vs-fractionnement" style={articleHeading}>
