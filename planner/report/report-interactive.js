...
(function() {
  ...
  function _injectRuntimeStyles() {
    ...
    style.textContent = [
      ...
      '.bf-whatif-presets{margin-bottom:18px;padding:14px 16px;background:#fdfbf6;border-radius:6px;border:1px solid #e8e0d4}',
      '.bf-whatif-presets-label{font-family:"Playfair Display",Georgia,serif;font-size:13px;font-weight:600;color:#5a4f3a;font-style:italic;margin-bottom:12px;letter-spacing:0.3px}',
      // Phase 2 — L1 curated decision cards. Premium grid, label + description per card.
      '.bf-whatif-card-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:10px}',
      '.bf-whatif-decision-card{display:flex;flex-direction:column;align-items:flex-start;gap:6px;text-align:left;background:#fff;border:1px solid #e8e0d4;border-radius:6px;padding:14px 16px;cursor:pointer;transition:all 0.15s;font-family:Inter,sans-serif;color:#252d39}',
      '.bf-whatif-decision-card:hover{border-color:#c4944a;background:#fdfbf6;box-shadow:0 1px 4px rgba(196,154,74,0.12)}',
      '.bf-whatif-decision-card.active{border-color:#c4944a;border-width:2px;padding:13px 15px;background:#fdf9ee;box-shadow:0 2px 6px rgba(196,154,74,0.18)}',
      '.bf-whatif-card-label{font-family:"Playfair Display",Georgia,serif;font-size:14px;font-weight:600;color:#252d39;line-height:1.25;letter-spacing:-0.1px}',
      '.bf-whatif-card-desc{font-family:Inter,sans-serif;font-size:11px;color:#6a6155;line-height:1.5;font-weight:400}',
      // Phase 2 — L2 advanced disclosure (collapsed by default for non-plain readers).
      '.bf-whatif-l2{margin:14px 0 0;border:1px solid #e8e0d4;border-radius:6px;background:#fff;padding:0}',
      '.bf-whatif-l2[open]{padding-bottom:14px}',
      '.bf-whatif-l2-summary{cursor:pointer;padding:12px 16px;font-family:Inter,sans-serif;font-size:11px;font-weight:600;color:#5a4f3a;letter-spacing:0.4px;text-transform:uppercase;list-style:none;display:flex;align-items:baseline;gap:6px}',
      '.bf-whatif-l2-summary::-webkit-details-marker{display:none}',
      '.bf-whatif-l2-summary::before{content:"▸";display:inline-block;color:#c4944a;font-size:10px;transition:transform 0.15s}',
      '.bf-whatif-l2[open] > .bf-whatif-l2-summary::before{transform:rotate(90deg)}',
      '.bf-whatif-l2-summary-hint{font-family:Inter,sans-serif;font-weight:400;text-transform:none;letter-spacing:0;color:#888;font-size:10.5px}',
      '.bf-whatif-l2-body{padding:0 16px 6px;border-top:1px solid #f0ece4}',
      '.bf-whatif-shocks{margin:14px 0 16px}',
      '.bf-whatif-shocks-label{font-size:10px;font-weight:600;color:#888;text-transform:uppercase;letter-spacing:0.5px;margin-bottom:8px}',
      '.bf-whatif-shocks-buttons{display:flex;flex-wrap:wrap;gap:6px}',
      '.bf-whatif-shock{background:#fff;border:1px solid #e8e0d4;border-radius:14px;padding:5px 11px;font-size:10.5px;font-weight:500;color:#6a6155;cursor:pointer;transition:all 0.15s;font-family:Inter,sans-serif}',
      '.bf-whatif-shock:hover{background:#f9f7f2;border-color:#c4944a;color:#252d39}',
      '.bf-whatif-shock.active{background:#c4944a;color:#fff;border-color:#c4944a}',
      // Legacy preset selectors retained for backwards-compat (no-op once removed)
      '.bf-whatif-presets-buttons{display:flex;flex-wrap:wrap;gap:6px}',
      '.bf-whatif-preset{display:none}',
      ...
      // Phase 2 split-pane compare strip: "Your plan" left, "Explored" right.
      '.bf-whatif-compare-strip{display:flex;flex-direction:column;gap:8px;margin:14px 0 18px;padding:14px 16px;background:#fdfbf6;border:1px solid #e8e0d4;border-radius:6px}',
      '.bf-whatif-compare-row{display:grid;grid-template-columns:1.5fr 1fr 24px 1fr 1fr;gap:10px;align-items:center;font-family:Inter,sans-serif}',
      '.bf-whatif-compare-rowlabel{font-size:11px;font-weight:600;color:#5a4f3a;letter-spacing:0.2px}',
      '.bf-whatif-compare-base,.bf-whatif-compare-explored{display:flex;flex-direction:column;gap:2px;padding:6px 10px;border-radius:4px}',
      '.bf-whatif-compare-base{background:#f5f8fc;border:1px solid #dbe4f0}',
      '.bf-whatif-compare-explored{background:#fdf9ee;border:1px solid #e8d8a8}',
      '.bf-whatif-compare-tag{font-size:8.5px;font-weight:700;color:#888;text-transform:uppercase;letter-spacing:0.6px}',
      '.bf-whatif-compare-base .bf-whatif-compare-tag{color:#4680c0}',
      '.bf-whatif-compare-explored .bf-whatif-compare-tag{color:#a87a3a}',
      '.bf-whatif-compare-val{font-family:"JetBrains Mono",monospace;font-size:14px;font-weight:700;color:#252d39}',
      '.bf-whatif-compare-arrow{font-size:14px;color:#a89460;text-align:center;font-weight:700}',
      '.bf-whatif-compare-delta{font-family:"JetBrains Mono",monospace;font-size:12px;font-weight:700;text-align:right}',
      '@media (max-width:720px){.bf-whatif-compare-row{grid-template-columns:1fr 1fr;}.bf-whatif-compare-arrow{display:none}.bf-whatif-compare-rowlabel{grid-column:1 / span 2;font-size:10.5px;color:#888}.bf-whatif-compare-delta{grid-column:1 / span 2}}',
