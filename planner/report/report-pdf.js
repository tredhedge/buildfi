...
(function() {
  ...
  function renderOverallAssessment(d) {
    ...
    else if (d.succVal != null && d.succVal >= 0.30) obs.push(fr ? '<svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true" style="vertical-align:-1px;margin-right:3px"><path d="M10.3 3.9 1.8 18a2 2 0 0 0 1.7 3h17a2 2 0 0 0 1.7-3L13.7 3.9a2 2 0 0 0-3.4 0Z"/><path d="M12 9v4M12 17h.01"/></svg>Plan fragile \u2014 le taux de ' + Math.round(d.succVal * 100) + '% laisse peu de marge face aux impr\u00e9vus.' : '<svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true" style="vertical-align:-1px;margin-right:3px"><path d="M10.3 3.9 1.8 18a2 2 0 0 0 1.7 3h17a2 2 0 0 0 1.7-3L13.7 3.9a2 2 0 0 0-3.4 0Z"/><path d="M12 9v4M12 17h.01"/></svg>Fragile plan \u2014 the ' + Math.round(d.succVal * 100) + '% rate leaves limited margin for the unexpected.');
    else if (d.succVal != null && d.succVal >= 0.10) obs.push(fr ? '<svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true" style="vertical-align:-1px;margin-right:3px"><path d="M10.3 3.9 1.8 18a2 2 0 0 0 1.7 3h17a2 2 0 0 0 1.7-3L13.7 3.9a2 2 0 0 0-3.4 0Z"/><path d="M12 9v4M12 17h.01"/></svg>Plan \u00e0 risque \u2014 un taux de ' + Math.round(d.succVal * 100) + '% sugg\u00e8re des ajustements structurels n\u00e9cessaires.' : '<svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true" style="vertical-align:-1px;margin-right:3px"><path d="M10.3 3.9 1.8 18a2 2 0 0 0 1.7 3h17a2 2 0 0 0 1.7-3L13.7 3.9a2 2 0 0 0-3.4 0Z"/><path d="M12 9v4M12 17h.01"/></svg>At-risk plan \u2014 a ' + Math.round(d.succVal * 100) + '% rate suggests structural adjustments are needed.');
    else if (d.succVal != null) obs.push(fr ? '<svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true" style="vertical-align:-1px;margin-right:3px"><path d="M10.3 3.9 1.8 18a2 2 0 0 0 1.7 3h17a2 2 0 0 0 1.7-3L13.7 3.9a2 2 0 0 0-3.4 0Z"/><path d="M12 9v4M12 17h.01"/></svg>Plan non viable en l\'\u00e9tat \u2014 un taux de ' + Math.round(d.succVal * 100) + '% indique qu\'une r\u00e9vision globale serait n\u00e9cessaire pour r\u00e9tablir la trajectoire.' : '<svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true" style="vertical-align:-1px;margin-right:3px"><path d="M10.3 3.9 1.8 18a2 2 0 0 0 1.7 3h17a2 2 0 0 0 1.7-3L13.7 3.9a2 2 0 0 0-3.4 0Z"/><path d="M12 9v4M12 17h.01"/></svg>Plan not sustainable as is \u2014 a ' + Math.round(d.succVal * 100) + '% rate indicates a global review would be necessary to restore the trajectory.');
  ...
  function renderGoals(d, secN) {
    ...
    if (overallSucc != null && maxProbMet > 0 && (maxProbMet - overallSucc) >= 20) {
      h += '<div class="callout callout-warning" style="margin:8px 0">' +
        '<div class="callout-lbl" style="color:#a07818"><svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true" style="vertical-align:-1px;margin-right:3px"><path d="M10.3 3.9 1.8 18a2 2 0 0 0 1.7 3h17a2 2 0 0 0 1.7-3L13.7 3.9a2 2 0 0 0-3.4 0Z"/><path d="M12 9v4M12 17h.01"/></svg>' + (fr ? 'Lecture: probabilit\u00e9 d\'objectif vs r\u00e9ussite du plan' : 'Reading note: goal probability vs plan success') + '</div>' +
        '<div style="font-size:11px;line-height:1.6;color:#333">' +
        (fr
  ...
  function renderSuccession(d, secN) {
    ...
    if (p.cOn && (p.penType === 'db' || p.cPenType === 'db')) {
      h += '<div class="cd survivor-benefit-callout" style="margin:10px 0;padding:10px 14px;background:#fdf6e3;border-left:3px solid ' + C.amber + ';font-size:11px;line-height:1.6">' +
        '<div style="font-weight:700;color:' + C.gold + ';font-size:11px;text-transform:uppercase;letter-spacing:0.5px;margin-bottom:6px">' +
        (fr ? '<svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true" style="vertical-align:-1px;margin-right:3px"><path d="M10.3 3.9 1.8 18a2 2 0 0 0 1.7 3h17a2 2 0 0 0 1.7-3L13.7 3.9a2 2 0 0 0-3.4 0Z"/><path d="M12 9v4M12 17h.01"/></svg>\u00c0 v\u00e9rifier \u2014 prestation du conjoint survivant' : '<svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true" style="vertical-align:-1px;margin-right:3px"><path d="M10.3 3.9 1.8 18a2 2 0 0 0 1.7 3h17a2 2 0 0 0 1.7-3L13.7 3.9a2 2 0 0 0-3.4 0Z"/><path d="M12 9v4M12 17h.01"/></svg>To verify \u2014 spouse survivor benefit') + '</div>' +
        (fr
  ...
  function renderStrategies(d, secN) {
    ...
    if (exp && ai.strengths) {
      ...
      (ai.vulnerabilities || []).forEach(function(v) { h += '<div style="margin:4px 0;font-size:10px"><svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true" style="vertical-align:-1px;margin-right:3px"><path d="M10.3 3.9 1.8 18a2 2 0 0 0 1.7 3h17a2 2 0 0 0 1.7-3L13.7 3.9a2 2 0 0 0-3.4 0Z"/><path d="M12 9v4M12 17h.01"/></svg>' + F.esc(v) + '</div>'; });
      h += '</div></div>';
    }
...
h += secPageEnd();
  ...
  function _renderSensitivityHeatmap(d, fr) {
    ...
    return '<div style="margin:18px 0 6px;font-size:11px;font-weight:600;color:' + C.gold + ';text-transform:uppercase;letter-spacing:.5px">' + (fr ? 'Carte thermique : rendement × inflation' : 'Heatmap: return × inflation') + '</div>' +
      ...
      '<strong style="color:#8a5500"><svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true" style="vertical-align:-1px;margin-right:3px"><path d="M10.3 3.9 1.8 18a2 2 0 0 0 1.7 3h17a2 2 0 0 0 1.7-3L13.7 3.9a2 2 0 0 0-3.4 0Z"/><path d="M12 9v4M12 17h.01"/></svg> ' + (fr ? 'Approximation pédagogique :' : 'Educational approximation:') + '</strong> ' +
